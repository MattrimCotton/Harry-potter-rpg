...
- Compte GitHub : **MattrimCotton**.
- Francophone : échanges, code du domaine et contenu du jeu en français.
- Étudiant en développement (cours 2026-2027 : programmation orientée objet, développement web).
- Très impliqué en accessibilité pour les personnes aveugles : plusieurs mods d'accessibilité de jeux vidéo pour lecteurs d'écran (CrossCode, Life is Strange: Before the Storm, Pokémon, Date Everything, RDLE…), NVDA/JAWS via Tolk.
- Considère le lecteur d'écran comme l'interface principale, pas comme un ajout. Les choix d'interface se jugent d'abord à l'oreille (NVDA + Firefox/Chrome).

## Façon de travailler

- Aime que l'assistant avance de manière autonome sur des demandes larges, puis rende compte.
- A passé le dépôt GitHub en public le 2026-09-24 (il était privé auparavant).
